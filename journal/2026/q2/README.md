...
- [W14](w14/README.md): SMT/Zig exploration, sail-xisa from bootstrap to full Parser ISA + MAP ISA + web playground, personal website (qobilidop.github.io) built
...
- SAIL-XISA: formal XISA spec in Sail — Parser ISA complete (42 variants, 24 tests), MAP ISA started (28 variants, 12 tests), 64-bit binary encoding, web playground (Rust/WASM). Strategy: Sail as ground truth oracle for future Python eDSL (W14)
