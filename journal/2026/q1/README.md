...
- [W13](w13/README.md): Z3Wire cleanup, cyborg reorg, library/inbox design, P4Py full push (architecture→init→e2e→P4Mini complete), personal website planned
...
- NEW-PROJECT: P4Py — Python eDSL for P4 subset using AST VM. Successor/complement to P4kt. Architecture designed, project initialized, P4Mini milestone complete (all W13 Fri).
