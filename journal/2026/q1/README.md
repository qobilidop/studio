...
Bili the Cyborg comes online. Repo bootstrap, Z3Wire library development, P4kt launch, and the journal/knowledge system taking shape.
...
- Cyborg repo: journal system (memory/ → journal/), knowledge/, skills (record-session, sync-journal). Multi-repo design (Cyborg, Artisan, Hermit, Clert, Website) decided W12 Sun.
- Tooling trajectory: Colima, SSH signing, devcontainers/ci, BuildBuddy, dprint, ruff, mdformat-mkdocs.
- Open: Z3Wire multiply/division, v0.1.0 release, P4kt v1model.p4, wiregen implementation, P4buf concept.
