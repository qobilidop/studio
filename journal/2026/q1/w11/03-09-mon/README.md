...
- **session-02** (Claude): Z3Wire — 24 compile-fail tests, tagline update, AGENTS.md structural rules
- **session-03** (Claude): Z3Wire — scope clarification (combinational logic primitives), README rewrite, tooling overhaul (buildifier, mdformat, shfmt, shellcheck), Bazel 9 upgrade
