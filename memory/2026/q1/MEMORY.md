...
- [W12](w12/MEMORY.md): Z3Wire Weave codegen (design → Python → C++ rewrite), type naming redesign, CI modernization (devcontainers/ci, BuildBuddy), shift API redesign, naming conventions (to_/as_/_cast), docs consolidation, API gap analysis, SInt storage simplification, wide BitVec (W > 64), Google FuzzTest, rotation ops, formatter/linter overhaul (dprint), Lean 4 explorations (P4 eDSL)
