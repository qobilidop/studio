...
- [W12](w12/MEMORY.md): Z3Wire Weave codegen tool, type naming redesign, CI modernization, shift API redesign, naming conventions (to_/as_/_cast), docs consolidation, API gap analysis, SInt storage simplification, usage docs overhaul, wide BitVec (W > 64), Google FuzzTest integration, rotation ops
